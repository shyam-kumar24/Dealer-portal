...
export default function CartCard({ data }) {
  ...
  return (
    <div className="flex items-center flex-grow justify-between gap-5 w-full  bg-gray-300 p-2 rounded-xl">
      <div>
        <img
          src={data.image}
      ...
      <div className="flex flex-col items-center mr-5">
        ...
        <button onClick={() => handlePlaceOrder()} className="flex items-center bg-gray-700 mt-2 text-white h-10 rounded-md px-2 cursor-pointer">
          Order Now
        </button>
      </div>
      {
